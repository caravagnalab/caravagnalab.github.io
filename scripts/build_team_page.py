...
PEOPLE_DIR = ROOT / "team"
OUTPUT = ROOT / "people.qmd"

CATEGORIES = [
    ("leadership", "Leadership", "Principal investigator", False),
    ("postdoctoral", "Scientists", "Postdoctoral researchers", True),
    ("phd", "Researchers in training", "PhD researchers", False),
    ("student", "Students", "MSc and BSc researchers", True),
    ("visiting", "Visitors", "Visiting PhD researchers", False),
    ("alumni", "Where they are now", "Alumni", True),
]
...
"""
    ...
    for key, eyebrow, title, tinted in CATEGORIES:
